...
subplot(3, 1, 3);
hold on;
plot(WinchData.Time_ms / 1000, WinchData.ThrottleServoSetpoint, 'c');
plot(WinchData.Time_ms / 1000, WinchData.FeedForwardComponent, 'g');
plot(WinchData.Time_ms / 1000, WinchData.ProportionalComponent, 'r');
plot(WinchData.Time_ms / 1000, WinchData.IntegralComponent, 'b');
plot(WinchData.Time_ms / 1000, WinchData.DifferentialComponent, 'm');
grid on; set(gca,'layer','top');
xlabel('Time [s]');
ylabel('Setpoint [0, 1]');
%% Plot Acceleration
...
plot(WinchData.Time_ms / 1000, WinchData.ThrottleServoSetpoint * 100, 'c');
grid on; set(gca,'layer','top');
xlabel('Time [s]');
